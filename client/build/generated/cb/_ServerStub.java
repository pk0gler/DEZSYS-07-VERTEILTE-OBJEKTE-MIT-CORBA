	...
	implements cb.Server
{
	...
	public final static java.lang.Class _opsClass = cb.ServerOperations.class;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					cb.CallBackHelper.write(_os,_cb);
					java.lang.String tmpResult1 = mesg;
_os.write_string( tmpResult1 );
					_os.write_ushort(period_secs);
					_is = _invoke(_os);
					return;
				}
		...
		else
		{
			...
			try
			{
				_localServant.register(_cb,mesg,period_secs);
	...
	public void one_time(cb.CallBack _cb, java.lang.String mesg)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "one_time", true);
					cb.CallBackHelper.write(_os,_cb);
					java.lang.String tmpResult2 = mesg;
_os.write_string( tmpResult2 );
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "one_time", _opsClass );
			if( _so == null )
				continue;
			ServerOperations _localServant = (ServerOperations)_so.servant;
			try
			{
				_localServant.one_time(_cb,mesg);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
